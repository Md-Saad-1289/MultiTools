    ...
    <div class="navbar-container">
      ...
      <div class="nav-actions">
        <button id="theme-toggle" class="theme-toggle-btn" aria-label="Toggle dark mode">
          <i data-lucide="sun" class="light-icon" id="sun-icon"></i>
          <i data-lucide="moon" class="dark-icon" id="moon-icon"></i>
        </button>
...
const toolsList = [
  ...
  },
  {
    ...
    html: `
      ...
      <button id="copy-qr-hint" class="btn btn-secondary w-full" style="display:none;">Copy Code</button>
...
toolsList.forEach(tool => {
  ...
  const pageHtml = layoutTemplate(
    ...
    '',
    '..',
    (tool.id === 'scientific-calculator' ? '<script src="https://cdnjs.cloudflare.com/ajax/libs/mathjs/11.8.0/math.js"></script>' : '') + pageScript
  );
...
const getHomeContent = () => {
  ...
  return `
    <!-- Hero Section -->
    <section class="section" style="background: linear-gradient(180deg, var(--bg-surface) 0%, var(--bg-primary) 100%); border-bottom:1px solid var(--border-color);">
      <div class="container text-center" style="max-width:800px; padding:40px 24px;">
        <h1 class="mb-16" style="font-size:46px;">All-in-One Online <span style="color:var(--color-primary);">Toolbox</span></h1>
        <p class="mb-32" style="font-size:18px; color:var(--text-secondary); max-width:600px; margin-left:auto; margin-right:auto;">
    ...
    <section class="container" id="popular-tools-section" style="padding-top:40px; padding-bottom:10px;">
